...
})({"Yk008":[function(require,module,exports) {
"use strict";
var HMR_HOST = null;
var HMR_PORT = null;
...
_view.UI_BUTTONS.settings.addEventListener('click', _view.openCloseSettings);
_view.UI_BUTTONS.settingsClose.addEventListener('click', _view.openCloseSettings);
_view.UI_BUTTONS.authorizationClose.addEventListener('click', ()=>{
    _view.closeModal(_view.UI_MODALS.authorization);
});
_view.UI_BUTTONS.approveClose.addEventListener('click', ()=>{
    _view.closeModal(_view.UI_MODALS.approve);
});
_view.UI_FORMS.approve.addEventListener('submit', (event)=>{
    event.preventDefault();
});
_view.UI_FORMS.approve.addEventListener('submit', setApproveCodeCookie);
_view.UI_FORMS.settings.addEventListener('submit', (event)=>{
    event.preventDefault();
});
_view.UI_FORMS.settings.addEventListener('submit', ()=>{
    changeUserName(_service.Rest_API_Data);
});
_view.UI_FORMS.newMessage.addEventListener('submit', (event)=>{
    event.preventDefault();
});
_view.UI_FORMS.newMessage.addEventListener('submit', ()=>{
    _socket.sendMessageWebSocket();
});
_view.UI_FORMS.newMessage.addEventListener('submit', _view.clearInput);
_view.UI_FORMS.authorization.addEventListener('submit', (event)=>{
    event.preventDefault();
});
_view.UI_FORMS.authorization.addEventListener('submit', ()=>{
    sendAuthorizationData(_service.Rest_API_Data, _view.authorizationEmail());
});
_view.UI_ELEM.chatBlock.addEventListener('scroll', ()=>{
...
function setApproveCodeCookie() {
    const approveCode = _view.UI_INPUTS.approveCode.value;
    _jsCookieDefault.default.set('approveCode', approveCode, {
        expires: 1
    });
    _view.UI_INPUTS.approveCode.value = '';
    _view.closeModal(_view.UI_MODALS.approve);
}
function checkCookie() {
    ...
    if (!notHasCookie) {
        ...
        _view.closeModal(_view.UI_MODALS.authorization);
        loadData();
    } else _view.closeModal(_view.UI_MODALS.dataLoad);
}
async function getHistory({ url , messageAPI  }, count) {
    try {
        ...
        _view.UI_ELEM.messageList.scrollIntoView({
            block: "end"
        });
...
async function changeUserName({ url , user  }) {
    const senderName = {
        name: _view.UI_INPUTS.settings.value
    };
    try {
        _view.UI_ELEM.preloader.classList.add('display__preloader');
        _service.setSenderName(senderName, url, user);
        aboutMe.name = senderName.name;
        _service.getAboutMe(_service.Rest_API_Data);
        _view.UI_ELEM.preloader.classList.remove('display__preloader');
        _view.closeModal(_view.UI_MODALS.settings);
    } catch (error) {
        alert(error.stack);
    }
}
...
function getMessageByCount(n, messagesJSON) {
    ...
    _view.sendHistoryMessageUI(collectMessageData(text, createdAt, name, email));
}
function addDisplayedMessages(count, array) {
    const scrollAtTop = _view.UI_ELEM.chatBlock.scrollTop;
    const isScrollAtTop = scrollAtTop === 0;
    if (array.length === 0) {
        _view.loadedAllMessages('Все сообщения были загружены');
        return;
    } else if (isScrollAtTop) {
        const messageToShow = array.splice(-count, count);
        setTimeout(()=>{
            getMessageByCount(count, messageToShow);
        }, 1000);
    }
}

},{"./view":"6UQ4h","./socket":"j5Hvw","./service":"adYie","date-fns":"9yHCA","js-cookie":"c8bBu","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"6UQ4h":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
function createMessageUIContent(elem, text, sendTime, sender, email) {
    ...
    const isSenderI = email === _main.aboutMe.email;
...
},{"./main":"WPhGI","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"gkKU3":[function(require,module,exports) {
...
},{}],"j5Hvw":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
const socket = new _reconnectingWebsocketDefault.default(_service.Rest_API_Data.webSocket);
function sendMessageWebSocket() {
    try {
        const message = _view.UI_INPUTS.message.value;
...
socket.onmessage = function(event) {
    try {
        ...
        if (brokenJSON) throw new Error('JSON was broken');
            ...
            console.log(_main.collectMessageData(text, createdAt, name, email));
            _view.sendNewMessageUI(_main.collectMessageData(text, createdAt, name, email));
        }
    } catch (error) {
        console.log(error.stack);
    }
...
},{"./view":"6UQ4h","./main":"WPhGI","./service":"adYie","reconnecting-websocket":"foTU5","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"adYie":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
async function checkAuthorization() {
    try {
        ...
        if (authorizationError) {
            ...
            _view.closeModal(_view.UI_MODALS.dataLoad);
            throw new _errors.AuthorizationError('Ошибка авторизации');
        }
    } catch (err) {
        if (err instanceof _errors.AuthorizationError) alert("Проверьте токен: " + err.message);
...
},{"js-cookie":"c8bBu","./main":"WPhGI","./view":"6UQ4h","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3","./errors":"6swum"}],"c8bBu":[function(require,module,exports) {
...
},{}],"6swum":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["Yk008","WPhGI"], "WPhGI", "parcelRequire25d8")
